...
if errorlevel 1 (
  echo Starting Dizi visualization...
  start "Dizi Visualization" /min cmd.exe /c "npm.cmd run dev -- --host 127.0.0.1 --port 4173"
  timeout /t 3 /nobreak >nul
)

start "" "http://127.0.0.1:4173/?instrument=dizi"
echo Opened Dizi visualization.
timeout /t 2 /nobreak >nul
