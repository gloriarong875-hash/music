...
/*
  ...
  - 修改画作数据：调整 works 数组；笛 sheet 中作品名非空的 23 条记录进入左侧编年数据，assets 中所有图片进入右侧画作鉴赏。
  ...
  - 修改背景颜色：调整 distyle.css 中 `.page { background-color: ... }` 和 `.page::after` 的渐变。
  ...
  - 右侧画作多时不要改变鼓的页面骨架，只在 distyle.css 末尾缩小 `.painting-grid` 单元格。
*/
...
const works = [
  ...
  },
  {
    ...
    "museum": "大都会博物馆",
    "period": "宋代",
    "intro": "《仿周文矩宫中图》为宋佚名作品，现藏大都会博物馆。画面属宫廷礼宴题材，可见古琴、笛子、阮（琵琶）等乐器，适合作为相关乐器图像资料。"
  },
  {
    "id": "D016102",
    "title": "陈风图",
  ...
  },
  {
    ...
    "museum": "南京博物院",
    "period": "元代",
    "intro": "《沧江横笛图》为元盛懋作品，现藏南京博物院。画面属文人雅集题材，可见笛等乐器，适合作为相关乐器图像资料。"
  },
  {
    "id": "D017141",
    "title": "群仙祝寿图",
  ...
  },
  {
    ...
    "museum": "私人藏",
    "period": "元代",
    "intro": "《宫女图（旧传桓野王图）》为元佚名（\"钱选\"印）作品，现藏私人藏。画面属宫廷礼宴题材，可见笛等乐器，适合作为相关乐器图像资料。"
  },
  {
    "id": "D000548",
    "title": "松溪横笛图",
    ...
    "museum": "南京博物院",
    "period": "明代",
    "intro": "《松溪横笛图》为明仇英作品，现藏南京博物院。画面属文人雅集题材，可见笛等乐器，适合作为相关乐器图像资料。"
  },
  {
    "id": "D002871",
    "title": "扁舟横笛图",
    ...
    "museum": "安徽博物院",
    "period": "明代",
    "intro": "《扁舟横笛图》为明文徵明作品，现藏安徽博物院。画面属文人雅集题材，可见633等乐器，适合作为相关乐器图像资料。"
  },
  {
    "id": "D010449",
    "title": "铁笛图（未开放下载",
    ...
    "museum": "上海博物馆",
    "period": "明代",
    "intro": "《铁笛图（未开放下载》为明吴伟作品，现藏上海博物馆。画面属文人雅集题材，可见633等乐器，适合作为相关乐器图像资料。"
  },
  {
    "id": "D012865",
    "title": "吹笛送客图",
    ...
    "museum": "天津博物馆",
    "period": "明代",
    "intro": "《吹笛送客图》为明尤求作品，现藏天津博物馆。画面属民间世俗题材，可见633等乐器，适合作为相关乐器图像资料。"
  },
  {
    "id": "D001301",
    "title": "桂月听笛图",
    ...
    "museum": "波士顿艺术博物馆",
    "period": "清代",
    "intro": "《桂月听笛图》为清冷枚作品，现藏波士顿艺术博物馆。画面属宫廷礼宴题材，可见笛等乐器，适合作为相关乐器图像资料。"
  },
  {
    "id": "D004744",
    "title": "万树园赐宴图",
  ...
  },
  {
    ...
    "museum": "天津博物馆",
    "period": "清代",
    "intro": "《春湖横笛图》为清蓝孟作品，现藏天津博物馆。画面属文人雅集题材，可见笛等乐器，适合作为相关乐器图像资料。"
  },
  {
    "id": "D013187",
    "title": "清溪横笛图",
    ...
    "museum": "天津博物馆",
    "period": "清代",
    "intro": "《清溪横笛图》为清恽寿平 钮硕儒作品，现藏天津博物馆。画面属民间世俗题材，可见笛等乐器，适合作为相关乐器图像资料。"
  },
  {
    "id": "D020878",
    "title": "铁笛楼图",
    ...
    "museum": "常州博物馆",
    "period": "清代",
    "intro": "《铁笛楼图》为清汤贻汾作品，现藏常州博物馆。画面属文人雅集题材，可见笛等乐器，适合作为相关乐器图像资料。"
  },
  {
    "id": "待补充",
    "title": "临流抚琴图",
  ...
  },
  {
    ...
    "museum": "未详",
    "period": "未详",
    "intro": "《仿马远松荫玩月图》已见原琴sheet，现据笛类资产截图补入笛sheet。画面以琴或高士清赏为主，截图显示其亦作为笛类相关图像资料使用。"
  },
  {
    "id": "待补充",
    "title": "会昌九老图",
  ...
  },
  {
    ...
    "museum": "未详",
    "period": "未详",
    "intro": "《周颂清庙之什图》传为马和之作，以《诗经·周颂》为本，十段书画表现宗庙礼乐，笛与编钟、笙、鼓共同指向雅乐仪式。"
  },
  {
    "id": "待补充",
    "title": "周颂清庙之什图局部2",
  ...
  },
  {
    ...
    "museum": "未详",
    "period": "未详",
    "intro": "《抚琴图》已见原琴sheet，现据笛类资产截图补入笛sheet。画面以琴或高士清赏为主，截图显示其亦作为笛类相关图像资料使用。"
  },
  {
    "id": "待补充",
    "title": "摹顾恺之斫琴图",
  ...
  },
  {
    ...
    "museum": "未详",
    "period": "未详",
    "intro": "《松荫鸣琴图》已见原琴sheet，现据笛类资产截图补入笛sheet。画面以琴或高士清赏为主，截图显示其亦作为笛类相关图像资料使用。"
  },
  {
    "id": "待补充",
    "title": "松阴策杖图",
  ...
  },
  {
    ...
    "museum": "未详",
    "period": "未详",
    "intro": "《柳溪卧笛图》绘高士柳岸卧吹横笛，人物虽小却点明主题，水墨山石与空阔水面营造清远闲逸的笛声意境。"
  },
  {
    "id": "待补充",
    "title": "水村楼阁图",
  ...
  },
  {
    ...
    "museum": "未详",
    "period": "未详",
    "intro": "《江岸停琴图》已见原琴sheet，现据笛类资产截图补入笛sheet。画面以琴或高士清赏为主，截图显示其亦作为笛类相关图像资料使用。"
  },
  {
    "id": "待补充",
    "title": "深堂琴趣图",
  ...
  },
  {
    ...
    "museum": "未详",
    "period": "未详",
    "intro": "《百子图》为南宋苏汉臣、王居正名下作品，现藏克利夫兰艺术博物馆。儿童庭园嬉戏中有吹笛、击鼓等场面，节庆童趣鲜明。"
  },
  {
    "id": "待补充",
    "title": "荷塘按乐图",
    ...
    "museum": "未详",
    "period": "未详",
    "intro": "《荷塘按乐图》以荷塘、曲栏和月台一角写御前按乐情景，乐伎助兴与水面清景相映，展现南宋宫廷宴游中的音乐氛围。"
  },
  {
    "id": "待补充",
    "title": "观瀑图",
    ...
    "museum": "未详",
    "period": "未详",
    "intro": "《观瀑图》已见原琴sheet，现据笛类资产截图补入笛sheet。画面以琴或高士清赏为主，截图显示其亦作为笛类相关图像资料使用。"
  }
];
...
function drawChart() {
  ...
  bands.forEach((band) => {
    ...
    band.nodes.forEach((node) => {
      ...
      const r = (8 + Math.sqrt(node.value) * 3.6) * lift.perspective;
  ...
  grid.innerHTML = assets.map((asset, index) => {
    ...
    return `
      <article class="painting-card" tabindex="0" data-index="${index}" data-shape="${asset.shape}">
        <img src="笛画作assets/${asset.file}" alt="${label}" loading="${loading}" decoding="async" />
...
function openLightbox(index) {
  ...
  setLightboxPan(0, 0);
  setLightboxZoom(1);
  img.src = `笛画作assets/${info.asset.file}`;
  img.alt = info.label;
